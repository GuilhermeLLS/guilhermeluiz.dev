...
function getStyles(theme) {
  switch (theme) {
    ...
    case "light" :
        return "text-white dark:text-gray-700";
    default:
      return "";
  }
}

function IconsSection$GitHubIcon(Props) {
  var url = Props.url;
  ...
  return React.createElement("a", {
              ...
              target: "_blank"
                  ...
                  className: "w-5 " + getStyles(theme) + " h-5 fill-current hover:text-indigo-500 dark:hover:text-indigo-400",
                  viewBox: "0 0 512 512",
...
function IconsSection$LinkedinIcon(Props) {
  var url = Props.url;
  var theme = Props.theme;
  return React.createElement("a", {
              className: "mx-2",
...
function IconsSection$TwitterIcon(Props) {
  var url = Props.url;
  var theme = Props.theme;
  return React.createElement("a", {
              className: "mx-2",
